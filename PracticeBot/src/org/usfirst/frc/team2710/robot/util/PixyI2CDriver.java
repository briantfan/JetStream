...
//		values = new PixyPacket();
	...
	public PixyI2CDriver(I2C argPixy, PixyPacket[] argPixyPacket, PixyPacket argValues){
		pixy = argPixy;
		packets = argPixyPacket;
		pExc = new RuntimeException("Pixy Exception: Invalid data/checksum");
		values = argValues;
	}
	...
	*/
	...
	public PixyPacket readPacket(int Signature) { //The signature should be which number object in 
