...
public class PixySPIDriver {
	...
	private static final Logger logger =
			Logger.getLogger(PixySPIDriver.class.getName());
	...
	public PixySPIDriver(SPI argPixy, HashMap<Integer, ArrayList<PixyPacket>> argPixyPacket){
		pixy = argPixy;
	...
	public int readPackets() { //The signature should be which number object in 
